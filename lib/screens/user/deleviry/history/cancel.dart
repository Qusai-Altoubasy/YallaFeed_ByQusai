...
class cancel extends StatelessWidget {
  ...
  cancel({ required this.donorphone,
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                          content:
                          Text('The ordered has been canceled successfully')),
                    );
                  ...
                  child: const Text(
                      "Cancel", style: TextStyle(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                ),
              ),
